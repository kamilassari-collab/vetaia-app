...
<section class="faq-section">
  <div class="section-inner">
    ...
    <div class="faq-inner">
      <div class="faq-item open" onclick="toggleFaq(this)"><div class="faq-q"><span class="faq-question">Comment automatiser les comptes-rendus de consultation vétérinaire ?</span><div class="faq-icon">+</div></div><div class="faq-answer"><p>Dictez votre consultation à voix haute pendant l'examen. VetaIA transcrit en temps réel et génère en un clic un compte-rendu SOAP complet — symptômes, examen clinique, diagnostic, traitement — prêt à signer en moins de 30 secondes.</p></div></div>
      <div class="faq-item" onclick="toggleFaq(this)"><div class="faq-q"><span class="faq-question">VetaIA peut-il aider pour les dosages médicamenteux et protocoles vétérinaires ?</span><div class="faq-icon">+</div></div><div class="faq-answer"><p>Oui. Posez directement votre question clinique : dosage d'antibiotique, protocole anesthésique, interactions médicamenteuses, suivi post-opératoire. VetaIA répond avec les sources bibliographiques correspondantes.</p></div></div>
      <div class="faq-item" onclick="toggleFaq(this)"><div class="faq-q"><span class="faq-question">Quelle est la différence entre VetaIA et un logiciel de gestion vétérinaire classique ?</span><div class="faq-icon">+</div></div><div class="faq-answer"><p>Les logiciels de gestion (Vetup, VetManager…) gèrent la facturation et les rendez-vous. VetaIA s'occupe du contenu clinique : rédaction des comptes-rendus, aide au diagnostic, réponses aux questions médicales. Les deux sont complémentaires.</p></div></div>
      <div class="faq-item" onclick="toggleFaq(this)"><div class="faq-q"><span class="faq-question">L'assistant IA remplace-t-il le jugement du vétérinaire ?</span><div class="faq-icon">+</div></div><div class="faq-answer"><p>Non. VetaIA est un outil d'aide à la décision réservé aux vétérinaires diplômés. Il vous fait gagner du temps sur la rédaction et l'administratif. Le diagnostic et la responsabilité clinique restent entièrement les vôtres.</p></div></div>
      <div class="faq-item" onclick="toggleFaq(this)"><div class="faq-q"><span class="faq-question">Les données de mes consultations sont-elles sécurisées et conformes RGPD ?</span><div class="faq-icon">+</div></div><div class="faq-answer"><p>Oui. Toutes les données sont hébergées en Europe, chiffrées en transit et au repos, conformes au RGPD. Vos consultations ne sont jamais utilisées pour entraîner des modèles d'IA tiers.</p></div></div>
      <div class="faq-item" onclick="toggleFaq(this)"><div class="faq-q"><span class="faq-question">VetaIA est-il gratuit pour les vétérinaires ?</span><div class="faq-icon">+</div></div><div class="faq-answer"><p>Oui, entièrement gratuit pendant la bêta — sans carte bancaire, sans limite de consultations. Accès immédiat après inscription en moins de 2 minutes.</p></div></div>
    </div>
  </div>
</section>
