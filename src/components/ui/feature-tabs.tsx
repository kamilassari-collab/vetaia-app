  ...
  return (
    <div style={{ background: "white", borderRadius: 14, border: "1px solid #E4EEEc", boxShadow: "0 8px 32px rgba(11,122,106,0.10), 0 2px 8px rgba(0,0,0,0.05)", overflow: "hidden", width: "100%" }}>
      ...
      <div style={{ background: "#1A2E2B", padding: "12px 16px", display: "flex", alignItems: "center", gap: 6 }}>
        ...
        <span style={{ marginLeft: 10, fontSize: 11.5, color: "rgba(255,255,255,0.45)", fontWeight: 500 }}>Leash AI — Compte-rendu</span>
      </div>
  ...
  return (
    <div style={{ background: "#162926", borderRadius: 16, border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 8px 32px rgba(0,0,0,0.25)", overflow: "hidden", width: "100%" }}>
      ...
      <div style={{ padding: 18, display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <div style={{ fontSize: 9.5, fontWeight: 700, letterSpacing: "0.07em", textTransform: "uppercase", color: "rgba(255,255,255,0.25)", marginBottom: -4 }}>Leash AI</div>
...
const tabs = [
  {
    ...
    description: "Dictez ou tapez vos observations — Leash AI génère un compte-rendu complet avec anamnèse, examen clinique et plan thérapeutique en terminologie vétérinaire certifiée.",
  ...
  },
  {
    ...
    description: "Leash AI décroche, comprend la demande, pose les bonnes questions et confirme le rendez-vous sans intervention humaine. En français naturel, 24h/24.",
